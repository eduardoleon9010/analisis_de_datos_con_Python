...
- Documentación de `sklearn.metrics` para el cálculo de `mean_squared_error` y `r2_score`.
- Documentación de NumPy sobre `np.arange()` para la generación de secuencias numéricas.
